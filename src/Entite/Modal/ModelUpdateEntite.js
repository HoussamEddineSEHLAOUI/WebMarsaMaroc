...
import EntiteUpdate from '../EntiteUpdate';
import './ModelAddEntite.css';

export const ModelUpdateEntite = ({ showModalAdd, setShowModaladd ,id ,nomEntite }) => {
          ...
          <animated.div style={animation}>
            <div className="ModalWrapper" showModal={showModalAdd}>
              <div className="ModalContent">
                ...
                <EntiteUpdate id={id} nomEntite={nomEntite} setShowModaladd={setShowModaladd}/>
              </div>
              <p
